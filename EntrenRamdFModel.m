function [Modelo, RMSE] = EntrenRamdFModel(DataEntrenar)
...
% Auto-generated by MATLAB on 05-Aug-2021 11:39:51
...
Modelo.predictFcn = @(x) treePredictFcn(predictorExtractionFcn(x));
...
Modelo.RegressionTree = regressionTree;
...
partitionedModel = crossval(Modelo.RegressionTree, 'KFold', 5);
