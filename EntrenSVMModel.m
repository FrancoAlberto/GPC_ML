function [Modelo, RMSE] = EntrenSVMModel(DataEntrenar)
...
% Auto-generated by MATLAB on 05-Aug-2021 11:41:53
...
Modelo.predictFcn = @(x) svmPredictFcn(predictorExtractionFcn(x));
...
Modelo.RegressionSVM = regressionSVM;
